...
var _toConsumableArray = require("@babel/runtime/helpers/toConsumableArray"), _extends = require("@babel/runtime/helpers/extends"), _classCallCheck = require("@babel/runtime/helpers/classCallCheck"), _createClass = require("@babel/runtime/helpers/createClass"), _assertThisInitialized$1 = require("@babel/runtime/helpers/assertThisInitialized"), _inherits = require("@babel/runtime/helpers/inherits"), _defineProperty$1 = require("@babel/runtime/helpers/defineProperty"), React = require("react"), invariant = require("invariant"), _slicedToArray = require("@babel/runtime/helpers/slicedToArray"), _objectWithoutProperties = require("@babel/runtime/helpers/objectWithoutProperties"), useStyles = require("substyle"), PropTypes = require("prop-types"), ReactDOM = require("react-dom");
...
var _toConsumableArray__default = _interopDefault(_toConsumableArray), _extends__default = _interopDefault(_extends), _classCallCheck__default = _interopDefault(_classCallCheck), _createClass__default = _interopDefault(_createClass), _assertThisInitialized__default = _interopDefault(_assertThisInitialized$1), _inherits__default = _interopDefault(_inherits), _defineProperty__default = _interopDefault(_defineProperty$1), React__default = _interopDefault(React), invariant__default = _interopDefault(invariant), _slicedToArray__default = _interopDefault(_slicedToArray), _objectWithoutProperties__default = _interopDefault(_objectWithoutProperties), useStyles__default = _interopDefault(useStyles), PropTypes__default = _interopDefault(PropTypes), ReactDOM__default = _interopDefault(ReactDOM);
...
var escapeRegex = function(str) {
  ...
  invariant__default.default("id" === parameterName || "display" === parameterName, 'Second arg must be either "id" or "display", got: "'.concat(parameterName, '"'));
  ...
  invariant__default.default(null !== indexDisplay || null !== indexId, "The markup '".concat(markup, "' does not contain either of the placeholders '__id__' or '__display__'")), 
  ...
  return new RegExp(regExps.map((function(regex) {
    var _serializedRegexParse = serializedRegexParser.exec(regex.toString()), _serializedRegexParse2 = _slicedToArray__default.default(_serializedRegexParse, 3), regexString = _serializedRegexParse2[1], regexFlags = _serializedRegexParse2[2];
    return invariant__default.default(!regexFlags, "RegExp flags are not supported. Change /".concat(regexString, "/").concat(regexFlags, " into /").concat(regexString, "/")), 
    "(".concat(regexString, ")");
  })).join("|"), "g");
  ...
  }, markupIteratee = function(markup, index, mentionPlainTextIndex, id, display, childIndex, lastMentionEndIndex) {
  ...
  return iterateMentionsMarkup(value, config, markupIteratee, textIteratee), void 0 === result ? value.length : result;
  ...
  return invariant__default.default(numberOfGroups === numberOfPlaceholders, "Number of capturing groups in RegExp ".concat(regex.toString(), " (").concat(numberOfGroups, ") does not match the number of placeholders in the markup '").concat(markup, "' (").concat(numberOfPlaceholders, ")")), 
  regex;
...
function createDefaultStyle(defaultStyle, getModifiers) {
  return function(ComponentToWrap) {
    var DefaultStyleEnhancer = function(_ref) {
      var style = _ref.style, className = _ref.className, classNames = _ref.classNames, rest = _objectWithoutProperties__default.default(_ref, [ "style", "className", "classNames" ]), modifiers = getModifiers ? getModifiers(rest) : void 0, styles = useStyles__default.default(defaultStyle, {
        style: style,
        className: className,
        classNames: classNames
      }, modifiers);
      return React__default.default.createElement(ComponentToWrap, _extends__default.default({}, rest, {
        style: styles
      }));
...
var _generateComponentKey = function(usedKeys, id) {
  ...
  _inherits__default.default(Highlighter, _Component);
  var _super = _createSuper(Highlighter);
  function Highlighter() {
    var _this;
    return _classCallCheck__default.default(this, Highlighter), _this = _super.apply(this, arguments), 
    _defineProperty__default.default(_assertThisInitialized__default.default(_this), "setCaretElement", (function(el) {
  ...
  return _createClass__default.default(Highlighter, [ {
    ...
    value: function() {
      ...
      React__default.default.createElement("div", _extends__default.default({}, style, {
        ref: containerRef
      }), resultComponents);
    }
  }, {
    ...
    value: function(string, key) {
      return React__default.default.createElement("span", _extends__default.default({}, this.props.style("substring"), {
        key: key
      }), string);
    }
  }, {
    ...
    value: function(children) {
      return React__default.default.createElement("span", _extends__default.default({}, this.props.style("caret"), {
...
_defineProperty__default.default(Highlighter, "propTypes", {
  selectionStart: PropTypes__default.default.number,
  selectionEnd: PropTypes__default.default.number,
  value: PropTypes__default.default.string.isRequired,
  onCaretPositionChange: PropTypes__default.default.func.isRequired,
  containerRef: PropTypes__default.default.oneOfType([ PropTypes__default.default.func, PropTypes__default.default.shape({
    current: "undefined" == typeof Element ? PropTypes__default.default.any : PropTypes__default.default.instanceOf(Element)
  }) ]),
...
}), _defineProperty__default.default(Highlighter, "defaultProps", {
  value: ""
});
...
var Suggestion = function(_Component) {
  ...
  function Suggestion() {
    return _classCallCheck__default.default(this, Suggestion), _super.apply(this, arguments);
  }
  return _createClass__default.default(Suggestion, [ {
    key: "render",
    value: function() {
      var rest = omit(this.props, [ "style", "classNames", "className" ], keys(Suggestion.propTypes));
      return React__default.default.createElement("li", _extends__default.default({}, rest, this.props.style), this.renderContent());
    }
  }, {
    key: "renderContent",
    value: function() {
    ...
    value: function(display) {
      ...
      return -1 === i ? React__default.default.createElement("span", style("display"), display) : React__default.default.createElement("span", style("display"), display.substring(0, i), React__default.default.createElement("b", style("highlight"), display.substring(i, i + query.length)), display.substring(i + query.length));
    }
  } ]), Suggestion;
}(React.Component);

_defineProperty__default.default(Suggestion, "propTypes", {
  ...
  ignoreAccents: PropTypes__default.default.bool,
  suggestion: PropTypes__default.default.oneOfType([ PropTypes__default.default.string, PropTypes__default.default.shape({
    id: PropTypes__default.default.oneOfType([ PropTypes__default.default.string, PropTypes__default.default.number ]).isRequired,
    display: PropTypes__default.default.string
  }) ]).isRequired,
  renderSuggestion: PropTypes__default.default.func,
...
function LoadingIndicator() {
  var styles = useStyles__default.default(), spinnerStyles = styles("spinner");
  return React__default.default.createElement("div", styles, React__default.default.createElement("div", spinnerStyles, React__default.default.createElement("div", spinnerStyles([ "element", "element1" ])), React__default.default.createElement("div", spinnerStyles([ "element", "element2" ])), React__default.default.createElement("div", spinnerStyles([ "element", "element3" ])), React__default.default.createElement("div", spinnerStyles([ "element", "element4" ])), React__default.default.createElement("div", spinnerStyles([ "element", "element5" ]))));
}

var SuggestionsOverlay = function(_Component) {
  _inherits__default.default(SuggestionsOverlay, _Component);
  var _super = _createSuper(SuggestionsOverlay);
  function SuggestionsOverlay() {
    var _this;
    _classCallCheck__default.default(this, SuggestionsOverlay);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
    return _this = _super.call.apply(_super, [ this ].concat(args)), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "handleMouseEnter", (function(index, ev) {
      _this.props.onMouseEnter && _this.props.onMouseEnter(index);
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "select", (function(suggestion, queryInfo) {
      _this.props.onSelect(suggestion, queryInfo);
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "setUlElement", (function(el) {
      _this.ulElement = el;
    })), _this;
  }
  return _createClass__default.default(SuggestionsOverlay, [ {
    key: "componentDidUpdate",
    value: function() {
    ...
    value: function() {
      ...
      return 0 !== countSuggestions(suggestions) || isLoading ? React__default.default.createElement("div", _extends__default.default({}, useStyles.inline({
        ...
        ref: containerRef
      }), React__default.default.createElement("ul", _extends__default.default({
    ...
    value: function() {
      ...
      return Object.values(this.props.suggestions).reduce((function(accResults, _ref) {
        ...
        return [].concat(_toConsumableArray__default.default(accResults), _toConsumableArray__default.default(results.map((function(result, index) {
    ...
    value: function(result, queryInfo, index) {
      ...
      return React__default.default.createElement(Suggestion$1, {
    ...
    value: function() {
      if (this.props.isLoading) return React__default.default.createElement(LoadingIndicator, {
...
_defineProperty__default.default(SuggestionsOverlay, "propTypes", {
  suggestions: PropTypes__default.default.object.isRequired,
  focusIndex: PropTypes__default.default.number,
  position: PropTypes__default.default.string,
  left: PropTypes__default.default.number,
  top: PropTypes__default.default.number,
  scrollFocusedIntoView: PropTypes__default.default.bool,
  ...
  children: PropTypes__default.default.oneOfType([ PropTypes__default.default.element, PropTypes__default.default.arrayOf(PropTypes__default.default.element) ]).isRequired
}), _defineProperty__default.default(SuggestionsOverlay, "defaultProps", {
  suggestions: {},
  onSelect: function() {
    return null;
  }
...
var getID = function(suggestion) {
  ...
  allowSpaceInQuery: PropTypes__default.default.bool,
  allowSuggestionsAboveCursor: PropTypes__default.default.bool,
  ignoreAccents: PropTypes__default.default.bool,
  ...
  suggestionsPortalHost: "undefined" == typeof Element ? PropTypes__default.default.any : PropTypes__default.default.PropTypes.instanceOf(Element),
  ...
  _inherits__default.default(MentionsInput, _React$Component);
  var _super = _createSuper(MentionsInput);
  function MentionsInput(_props) {
    var _this;
    return _classCallCheck__default.default(this, MentionsInput), _this = _super.call(this, _props), 
    _defineProperty__default.default(_assertThisInitialized__default.default(_this), "setContainerElement", (function(el) {
      _this.containerElement = el;
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "getInputProps", (function() {
      var _this$props = _this.props, readOnly = _this$props.readOnly, disabled = _this$props.disabled, style = _this$props.style;
      return _objectSpread2(_objectSpread2(_objectSpread2({}, omit(_this.props, [ "style", "classNames", "className" ], keys(propTypes))), style("input")), {}, {
    ...
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "renderControl", (function() {
      var _this$props2 = _this.props, singleLine = _this$props2.singleLine, style = _this$props2.style, inputProps = _this.getInputProps();
      return React__default.default.createElement("div", style("control"), _this.renderHighlighter(), singleLine ? _this.renderInput(inputProps) : _this.renderTextarea(inputProps));
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "renderInput", (function(props) {
      return React__default.default.createElement("input", _extends__default.default({
        type: "text",
        ref: _this.setInputRef
      }, props));
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "renderTextarea", (function(props) {
      return React__default.default.createElement("textarea", _extends__default.default({
        ref: _this.setInputRef
      }, props));
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "setInputRef", (function(el) {
      _this.inputElement = el;
      var inputRef = _this.props.inputRef;
      "function" == typeof inputRef ? inputRef(el) : inputRef && (inputRef.current = el);
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "setSuggestionsElement", (function(el) {
      _this.suggestionsElement = el;
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "renderSuggestionsOverlay", (function() {
      if (!isNumber(_this.state.selectionStart)) return null;
      var _this$state$suggestio = _this.state.suggestionsPosition, position = _this$state$suggestio.position, left = _this$state$suggestio.left, top = _this$state$suggestio.top, suggestionsNode = React__default.default.createElement(SuggestionsOverlay$1, {
    ...
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "getPlainText", (function() {
      return getPlainText(_this.props.value || "", readConfigFromChildren(_this.props.children));
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "executeOnChange", (function(event) {
    ...
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "handleChange", (function(ev) {
    ...
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "handleSelect", (function(ev) {
      if (_this.setState({
    ...
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "handleKeyDown", (function(ev) {
    ...
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "shiftFocus", (function(delta) {
    ...
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "selectFocused", (function() {
      var _this$state2 = _this.state, suggestions = _this$state2.suggestions, focusIndex = _this$state2.focusIndex, _Object$values$reduce = Object.values(suggestions).reduce((function(acc, _ref) {
        var results = _ref.results, queryInfo = _ref.queryInfo;
        return [].concat(_toConsumableArray__default.default(acc), _toConsumableArray__default.default(results.map((function(result) {
          return {
            result: result,
            queryInfo: queryInfo
          };
    ...
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "handleBlur", (function(ev) {
    ...
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "handleSuggestionsMouseDown", (function(ev) {
      _this._suggestionsMouseDown = !0;
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "handleSuggestionsMouseEnter", (function(focusIndex) {
      _this.setState({
        focusIndex: focusIndex,
        scrollFocusedIntoView: !1
      });
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "updateSuggestionsPosition", (function() {
    ...
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "updateHighlighterScroll", (function() {
    ...
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "handleCompositionStart", (function() {
      isComposing = !0;
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "handleCompositionEnd", (function() {
      isComposing = !1;
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "setSelection", (function(selectionStart, selectionEnd) {
    ...
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "updateMentionsQueries", (function(plainTextValue, caretPosition) {
      ...
      if (null !== positionInValue) {
        ...
        React__default.default.Children.forEach(children, (function(child, childIndex) {
          if (child) {
    ...
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "clearSuggestions", (function() {
      _this._queryId++, _this.suggestions = {}, _this.setState({
        suggestions: {},
        focusIndex: 0
      });
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "queryData", (function(query, childIndex, querySequenceStart, querySequenceEnd, plainTextValue) {
    ...
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "updateSuggestions", (function(queryId, childIndex, query, querySequenceStart, querySequenceEnd, plainTextValue, results) {
      if (queryId === _this._queryId) {
        _this.suggestions = _objectSpread2(_objectSpread2({}, _this.suggestions), {}, _defineProperty__default.default({}, childIndex, {
          queryInfo: {
            childIndex: childIndex,
            query: query,
    ...
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "addMention", (function(_ref2, _ref3) {
    ...
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "isLoading", (function() {
      var isLoading = !1;
      return React__default.default.Children.forEach(_this.props.children, (function(child) {
        isLoading = isLoading || child && child.props.isLoading;
      })), isLoading;
    })), _defineProperty__default.default(_assertThisInitialized__default.default(_this), "_queryId", 0), 
    _this.suggestions = {}, _this.handleCopy = _this.handleCopy.bind(_assertThisInitialized__default.default(_this)), 
    _this.handleCut = _this.handleCut.bind(_assertThisInitialized__default.default(_this)), 
    _this.handlePaste = _this.handlePaste.bind(_assertThisInitialized__default.default(_this)), 
    _this.state = {
      focusIndex: 0,
      selectionStart: null,
      selectionEnd: null,
  ...
  return _createClass__default.default(MentionsInput, [ {
    key: "componentDidMount",
    value: function() {
    ...
    key: "render",
    value: function() {
      return React__default.default.createElement("div", _extends__default.default({
    ...
    value: function(event) {
      if (event.target === this.inputElement && this.supportsClipboardActions(event)) {
        ...
        var _this$state3 = this.state, selectionStart = _this$state3.selectionStart, selectionEnd = _this$state3.selectionEnd, _this$props7 = this.props, value = _this$props7.value, children = _this$props7.children, config = readConfigFromChildren(children), markupStartIndex = mapPlainTextIndex(value, config, selectionStart, "START"), markupEndIndex = mapPlainTextIndex(value, config, selectionEnd, "END"), pastedMentions = event.clipboardData.getData("text/react-mentions"), pastedData = event.clipboardData.getData("text/plain"), newValue = spliceString(value, markupStartIndex, markupEndIndex, pastedMentions || pastedData).replace(/\r/g, ""), newPlainTextValue = getPlainText(newValue, config), eventMock = {
          target: _objectSpread2(_objectSpread2({}, event.target), {}, {
            value: newValue
          })
        };
...
_defineProperty__default.default(MentionsInput, "propTypes", propTypes), _defineProperty__default.default(MentionsInput, "defaultProps", {
  ignoreAccents: !1,
  singleLine: !1,
...
var getComputedStyleLengthProp = function(forElement, propertyName) {
  ...
  return React__default.default.createElement("strong", styles, display);
};
...
Mention.propTypes = {
  ...
  renderSuggestion: PropTypes__default.default.func,
  trigger: PropTypes__default.default.oneOfType([ PropTypes__default.default.string, PropTypes__default.default.instanceOf(RegExp) ]),
  markup: PropTypes__default.default.string,
  displayTransform: PropTypes__default.default.func,
  allowSpaceInQuery: PropTypes__default.default.bool,
  isLoading: PropTypes__default.default.bool
