...
var useStyles__default = /*#__PURE__*/_interopDefault(useStyles);
...
var findPositionOfCapturingGroup = function findPositionOfCapturingGroup(markup, parameterName) {
  invariant__default['default'](parameterName === 'id' || parameterName === 'display', "Second arg must be either \"id\" or \"display\", got: \"".concat(parameterName, "\"")); // find positions of placeholders in the markup
  ...
  invariant__default['default'](indexDisplay !== null || indexId !== null, "The markup '".concat(markup, "' does not contain either of the placeholders '__id__' or '__display__'"));
...
var combineRegExps = function combineRegExps(regExps) {
  ...
  return new RegExp(regExps.map(function (regex) {
    var _serializedRegexParse = serializedRegexParser.exec(regex.toString()),
        _serializedRegexParse2 = _slicedToArray__default['default'](_serializedRegexParse, 3),
        regexString = _serializedRegexParse2[1],
        regexFlags = _serializedRegexParse2[2];

    invariant__default['default'](!regexFlags, "RegExp flags are not supported. Change /".concat(regexString, "/").concat(regexFlags, " into /").concat(regexString, "/"));
...
var coerceCapturingGroups = function coerceCapturingGroups(regex, markup) {
  ...
  invariant__default['default'](numberOfGroups === numberOfPlaceholders, "Number of capturing groups in RegExp ".concat(regex.toString(), " (").concat(numberOfGroups, ") does not match the number of placeholders in the markup '").concat(markup, "' (").concat(numberOfPlaceholders, ")"));
  return regex;
};
  ...
  var enhance = function enhance(ComponentToWrap) {
    var DefaultStyleEnhancer = function DefaultStyleEnhancer(_ref) {
      var style = _ref.style,
          ...
          rest = _objectWithoutProperties__default['default'](_ref, ["style", "className", "classNames"]);

      var modifiers = getModifiers ? getModifiers(rest) : undefined;
      var styles = useStyles__default['default'](defaultStyle, {
        style: style,
        className: className,
        classNames: classNames
      }, modifiers);
      return /*#__PURE__*/React__default['default'].createElement(ComponentToWrap, _extends__default['default']({}, rest, {
        style: styles
      }));
    };
...
var Highlighter = /*#__PURE__*/function (_Component) {
  ...
  _createClass__default['default'](Highlighter, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default['default'].createElement("div", _extends__default['default']({}, style, {
        ref: containerRef
      }), resultComponents);
    }
  }, {
    ...
    value: function renderSubstring(string, key) {
      ...
      return /*#__PURE__*/React__default['default'].createElement("span", _extends__default['default']({}, this.props.style('substring'), {
        key: key
      }), string);
    ...
    value: function renderHighlighterCaret(children) {
      return /*#__PURE__*/React__default['default'].createElement("span", _extends__default['default']({}, this.props.style('caret'), {
...
var Suggestion = /*#__PURE__*/function (_Component) {
  ...
  function Suggestion() {
    _classCallCheck__default['default'](this, Suggestion);

    return _super.apply(this, arguments);
  }

  _createClass__default['default'](Suggestion, [{
    key: "render",
    value: function render() {
      var rest = omit(this.props, ['style', 'classNames', 'className'], // substyle props
      keys(Suggestion.propTypes));
      return /*#__PURE__*/React__default['default'].createElement("li", _extends__default['default']({}, rest, this.props.style), this.renderContent());
    }
  }, {
    key: "renderContent",
    ...
    value: function renderHighlightedDisplay(display) {
      ...
      if (i === -1) {
        return /*#__PURE__*/React__default['default'].createElement("span", style('display'), display);
      }

      return /*#__PURE__*/React__default['default'].createElement("span", style('display'), display.substring(0, i), /*#__PURE__*/React__default['default'].createElement("b", style('highlight'), display.substring(i, i + query.length)), display.substring(i + query.length));
    }
  }]);
...
function LoadingIndicator() {
  var styles = useStyles__default['default']();
  var spinnerStyles = styles('spinner');
  return /*#__PURE__*/React__default['default'].createElement("div", styles, /*#__PURE__*/React__default['default'].createElement("div", spinnerStyles, /*#__PURE__*/React__default['default'].createElement("div", spinnerStyles(['element', 'element1'])), /*#__PURE__*/React__default['default'].createElement("div", spinnerStyles(['element', 'element2'])), /*#__PURE__*/React__default['default'].createElement("div", spinnerStyles(['element', 'element3'])), /*#__PURE__*/React__default['default'].createElement("div", spinnerStyles(['element', 'element4'])), /*#__PURE__*/React__default['default'].createElement("div", spinnerStyles(['element', 'element5']))));
}
...
var SuggestionsOverlay = /*#__PURE__*/function (_Component) {
  ...
  function SuggestionsOverlay() {
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "handleMouseEnter", function (index, ev) {
  ...
  _createClass__default['default'](SuggestionsOverlay, [{
    key: "componentDidUpdate",
    value: function componentDidUpdate() {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default['default'].createElement("div", _extends__default['default']({}, useStyles.inline({
        ...
        ref: containerRef
      }), /*#__PURE__*/React__default['default'].createElement("ul", _extends__default['default']({
    ...
    value: function renderSuggestion(result, queryInfo, index) {
      ...
      return /*#__PURE__*/React__default['default'].createElement(Suggestion$1, {
    ...
    value: function renderLoadingIndicator() {
      ...
      return /*#__PURE__*/React__default['default'].createElement(LoadingIndicator, {
...
var propTypes = {
  ...
  suggestionsPortalHost: typeof Element === 'undefined' ? PropTypes__default['default'].any : PropTypes__default['default'].PropTypes.instanceOf(Element),
...
var MentionsInput = /*#__PURE__*/function (_React$Component) {
  ...
  function MentionsInput(_props) {
    ...
    _classCallCheck__default['default'](this, MentionsInput);
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "getInputProps", function () {
      ...
      keys(propTypes));
      return _objectSpread2(_objectSpread2(_objectSpread2({}, props), style('input')), {}, {
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "renderControl", function () {
      ...
      return /*#__PURE__*/React__default['default'].createElement("div", style('control'), _this.renderHighlighter(), singleLine ? _this.renderInput(inputProps) : _this.renderTextarea(inputProps));
    });
    ...
    _defineProperty__default['default'](_assertThisInitialized__default['default'](_this), "renderSuggestionsOverlay", function () {
      ...
      var suggestionsNode = /*#__PURE__*/React__default['default'].createElement(SuggestionsOverlay$1, {
      ...
      if (_this.props.suggestionsPortalHost) {
        return /*#__PURE__*/ReactDOM__default['default'].createPortal(suggestionsNode, _this.props.suggestionsPortalHost);
      } else {
    ...
    _this.suggestions = {};
    _this.handleCopy = _this.handleCopy.bind(_assertThisInitialized__default['default'](_this));
  ...
  _createClass__default['default'](MentionsInput, [{
    key: "componentDidMount",
    value: function componentDidMount() {
...
_defineProperty__default['default'](MentionsInput, "propTypes", propTypes);

_defineProperty__default['default'](MentionsInput, "defaultProps", {
  ignoreAccents: false,
  singleLine: false,
...
var Mention = function Mention(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("strong", styles, display);
};
